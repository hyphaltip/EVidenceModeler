...
pub fn run_single_partition(
    ...
    let mut all_introns_to_score = HashMap::new();
    let mut all_introns_to_evidence: HashMap<String, Vec<(String, String)>> = HashMap::new();
    let mut all_predicted_introns = HashMap::new();
